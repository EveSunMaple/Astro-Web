...
export async function GET(context: any) {
  ...
  const items = await Promise.all(sortedblogs.map(async (blog: any) => {
    ...
    return {
      ...
      content: `<blockquote>This rendering was automatically generated by Frosti Feed and may have formatting issues. For the best experience, please visit: <a href="${blogURL}">${blogURL}</a></blockquote> ${content}`,
      customData: `
        <dc:creator><![CDATA[https://www.saroprock.com]]></dc:creator>
